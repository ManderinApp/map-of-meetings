...
function initMap() {
    ...
    // Обробник кліку по карті - виправлений
...
// Додамо функцію для тестування мітки
function testMarker() {
    const testLoc = {lat: 50.4501, lng: 30.5234};
    if (tempMarker) map.removeLayer(tempMarker);
    tempMarker = L.marker([testLoc.lat, testLoc.lng]).addTo(map);
    console.log("Тестова мітка додана");
}
